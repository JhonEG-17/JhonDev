        ...
        this.innerHTML = `
            <section class="__home-content" id="home">
                ...
                <div class="__home-btns">
                    ...
                    <a class="__links-item icon-linkedin-no-bg" href="https://www.linkedin.com/in/jhoneg" target="_blank" rel="noopener noreferrer" aria-label="enlace a perfil de LinkedIn"></a>
                    <a class="__links-item icon-github" href="https://github.com/JhonEG-17" target="_blank" rel="noopener noreferrer" aria-label="enlace a perfil de GitHub"></a>
                </div>
            </section>
        `;
    }
