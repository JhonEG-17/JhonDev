        ...
        this.innerHTML = `
            <section id="about" class="section-about">
                ...
                <article class="__about-text">
                    ...
                    <p class="__text">Mi nombre es Jhonatan Espinal, tengo 22 años y soy un desarrollador web con muchas ganas de crear soluciones tecnológicas y así brindar soluciones a problemas reales.</p>
